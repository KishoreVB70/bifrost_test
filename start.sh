...
wget -qO- --method=PUT \
  --body-data="{\"client_config\": {\"enforce_governance_header\": true, \"log_retention_days\": 7}, \"auth_config\": {\"is_enabled\": true, \"disable_auth_on_inference\": true, \"admin_username\": \"${BIFROST_ADMIN_USER}\", \"admin_password\": \"${BIFROST_ADMIN_PASS}\"}}" \
